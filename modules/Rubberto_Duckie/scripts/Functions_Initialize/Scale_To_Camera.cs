...
%Size.X=(%Size.X*Rubberto_Duckie.Resolution.X)/%Ass.Optimal_Resolution.X;

%Size.Y=(%Size.Y*Rubberto_Duckie.Resolution.Y)/%Ass.Optimal_Resolution.Y;
...
%Size.X=(%Size.X*Rubberto_Duckie.Camera_Size.X)/Rubberto_Duckie.Resolution.X;

%Size.Y=(%Size.Y*Rubberto_Duckie.Camera_Size.Y)/Rubberto_Duckie.Resolution.Y;
...
%Vector_2D_Scaled.X-=Rubberto_Duckie.Resolution.X/2;//offset cus cam is from -50 to 50

%Vector_2D_Scaled.Y-=Rubberto_Duckie.Resolution.Y/2;//offset cus cam is from -30 to 30

%Vector_2D_Scaled.Y=-%Vector_2D_Scaled.Y;//flip cus -y is down and +y is up

%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Rubberto_Duckie.Camera_Size.X)/Rubberto_Duckie.Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Rubberto_Duckie.Camera_Size.Y)/Rubberto_Duckie.Resolution.Y;
...
%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Rubberto_Duckie.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Rubberto_Duckie.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Rubberto_Duckie.Camera_Size.X)/Rubberto_Duckie.Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Rubberto_Duckie.Camera_Size.Y)/Rubberto_Duckie.Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Rubberto_Duckie.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Rubberto_Duckie.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Rubberto_Duckie.Resolution.X)/Rubberto_Duckie.Camera_Size.X;

%Vector_2D.Y=(%Vector_2D.Y*Rubberto_Duckie.Resolution.Y)/Rubberto_Duckie.Camera_Size.Y;
