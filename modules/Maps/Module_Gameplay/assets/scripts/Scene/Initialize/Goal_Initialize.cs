...
%Vector_2D_Randomized_Offset.X=getRandomF(0+(%this.Vector_2D_Goal_Size.X),%this.Vector_2D_World_Limits.X-(%this.Vector_2D_Goal_Size.X));

%Vector_2D_Randomized_Offset.Y=getRandomF(0+(%this.Vector_2D_Goal_Size.Y),%this.Vector_2D_World_Limits.Y-(%this.Vector_2D_Goal_Size.Y));
